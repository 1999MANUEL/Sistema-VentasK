...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Plan de Cuentas</h1>
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        @can('editar-cuenta')
                                        <li><a class="dropdown-item" href="{{ route('cuentas.edit', ['cuenta' => $cuenta->id]) }}">Editar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                    @can('eliminar-cuenta')
                                    @if ($cuenta->estado == 1)
                                    <button title="Eliminar" data-bs-toggle="modal" data-bs-target="#confirmModal-{{ $cuenta->id }}" class="btn btn-datatable btn-icon btn-transparent-dark">
                                    ...
                                    @else
                                    <button title="Restaurar" data-bs-toggle="modal" data-bs-target="#confirmModal-{{ $cuenta->id }}" class="btn btn-datatable btn-icon btn-transparent-dark">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $cuenta->estado == 1 ? '¿Seguro que quieres eliminar esta cuenta?' : '¿Seguro que quieres restaurar esta cuenta?' }}
                                </div>
